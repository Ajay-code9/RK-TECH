...
const Panel = ({ open, setOpen, id, Icon, title, imgSrc, description }) => {
  ...
  return (
    <>
      <button
        className="glassmorphism hover:bg-black transition-colors p-3 border-r-[1px] border-b-[1px] border-white flex flex-row-reverse lg:flex-col justify-end items-center gap-4 text-gray-300 relative group"
        onClick={() => setOpen(id)}
      >
        <span
          style={{
        ...
        <span className="w-4 h-4 bg-black group-hover:bg-black transition-colors border-r-[1px] border-b-[1px] lg:border-b-0 lg:border-t-[1px] rotate-45 absolute bottom-0 lg:bottom-[50%] right-[50%] lg:right-0 translate-y-[50%] translate-x-[50%] z-20" />
      </button>
  ...
  const items = [
    {
      ...
      description: "Choose from a wide range of products to suit your needs and preferences.",
      Icon: FiDollarSign,
    ...
    },
    {
      id: 2,
      title: "24/7 Support",
      description: "Get assistance round the clock, ensuring a seamless shopping experience.",
      Icon: FiPlay,
    ...
    },
    {
      id: 3,
      title: "Fast Delivery",
      description: "Receive your orders swiftly, without any unnecessary delays.",
      Icon: FiBell,
    ...
    },
    {
      id: 4,
      title: "Data Sources",
      description: "Access various data sources including APIs and databases to gather information.",
      Icon: FiBarChart,
